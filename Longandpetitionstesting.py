...
path= '/Users/simply/Documents/BLM-workspace/Mixed docs'
#path= '/Users/simply/Documents/BLM-workspace/Petition Sample'
#path= '/Users/simply/Documents/BLM-workspace/Petition Sample copy'
x=0
    ...
    if file.endswith('.pdf'):
      #  assert isinstance(file,IOBase)
        ...
        #     print pgtext
          ...
          re.search('Table of contents', pgtext) or re.search('TABLE OF CONTENTS', pgtext) or re.search('Contents',pgtext))
          if match:
              ...
              match=(re.search('Appendix',pgtext) or re.search('Executive Summary',pgtext) or re.search('Key Findings',pgtext))
              if match:
        ...
        # not a long doc, check if it is a petition format
            ...
            for i in range(0, pdfReader.numPages):
                ...
                pgtext = pageObj.extractText()
                print pgtext
                start = pgtext.find('Dear') or page.find('Dear Sir') or re.search('[t|T]o.*[w|W]hom.*[i|I]t.*[m|M]ay.*[c|C]oncern',pgtext)
                ...
                if (start == -1) and (end == -1):
                    ...
                    if i == 0:
                        ...
                        petitionLetter.append(pgtext)       # store the text
                        break
                elif (start == -1) and (end != -1):
                    if i == 0:
                        petitionLetter.append(pgtext)       #strore the text
                        print " Found only end"
                        break
                else:
                    petitionLetter.append(pgtext)
